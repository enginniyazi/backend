...
import { createCourse, getAllPublishedCourses, getCourseById, updateCourse, deleteCourse, togglePublishStatus, getMyCourses, getAllCoursesForAdmin, addLectureToSection, addSectionToCourse, updateSection, deleteSection, updateLecture, deleteLecture } from '../controllers/courseController.js';
