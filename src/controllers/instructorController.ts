...
export const getAllInstructorProfiles = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const deleteInstructorProfile = async (req: Request, res: Response, next: NextFunction) => {
