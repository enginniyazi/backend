...
export class TestHelpers {
    ...
    static generateToken(userId, role) {
        return jwt.sign({ id: userId, role }, this.JWT_SECRET, { expiresIn: '1h' });
    }
    ...
    // Test kursu oluştur
    static async createTestCourse(instructorId, categoryIds) {
...
TestHelpers.JWT_SECRET = 'test-secret-key';
